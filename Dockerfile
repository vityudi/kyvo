...
# ---------------------------------------------------------------------------
# admin-ui-build: compila o painel React/Vite (servido na raiz) -> admin-ui/dist
# ---------------------------------------------------------------------------
...
# admin-ui/dist so e servido pelo processo "app" (ver src/routes/admin.ts).
# ---------------------------------------------------------------------------
...
COPY --from=admin-ui-build /app/admin-ui/dist ./admin-ui/dist
